...
- Задвижка 2 открыта → текст сообщения - Задвижка 2 закрыта
...
- Бак заполнен 1 <20% → текст сообщения - Бак 1 пуст
- Бак заполнен 2 >80% → текст сообщения - Бак 2 переполнен
- Бак заполнен 2 >80% → текст сообщения - Бак 2 почти полон
- Бак заполнен 2 >80% → текст сообщения - Бак 2 почти пуст
- Бак заполнен 1 >80% → текст сообщения - Бак 2 пуст
- Насос 1 включён → текст сообщения - Насос 1 включён
- Насос 1 выключен → текст сообщения - Насос 1 выключен
- Насос 2 включён → текст сообщения - Насос 2 включён
- Насос 2 выключен → текст сообщения - Насос 2 выключен
